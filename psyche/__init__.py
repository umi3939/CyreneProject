...
Category sections:
  1. Kiban (Foundation)       -- state, pillars, fear, snapshot, persistence
  2. Kanjou (Emotion)         -- reaction, dynamics, amplitude, multi_emotion, coupling, meta, backdrop, cooccurrence
  3. Kioku (Memory)           -- memory_link, STM, STM loop, reaction_with_stm, episodic, binding, integration, forgetting, recall, spontaneous_recall, balance
  4. Naisei (Introspection)   -- self_reference, trace, self_model, temporal_diff, strain, self_image, coherence, narrative, consumption, long_term, tendency_awareness, input_supply, ref_freq, cross_section, longitudinal, contradiction
  5. Handan (Judgment)        -- decision_bias, thought, context_sensitivity, stability_valve, policy_expansion, scoring_fluctuation
  6. Mokuteki (Purpose)       -- value_orientation, proto_goal, goal_candidates, transient_goal, scoped_goal, repeated_tendency, persistent_commitment, goal_hierarchy
  7. Sekinin (Responsibility) -- responsibility, manager, dispersion, temporal_trace
  8. Tasha Ninchi (Other-cognition) -- other_agent_model, real_feed, dialogue_learning, boundary, hypothesis_observation
  9. Chikaku (Perception)     -- perception, self_action, intent_action_gap, temporal_cognition, perceptual_context
 10. Nyuuryoku (Input)        -- text_dialogue_input, input_pathway_balance
 11. Kidou (Activation)       -- spontaneous_activation
 12. Shutsuryoku (Output)     -- expression, silence_hesitation, tone
 13. Kansoku (Observation)    -- action_result_observation, selection_attribution
 14. Kudou (Drive)            -- intrinsic_motivation, drive_variation_description
 15. Jiko Ninchi (Self-cognition) -- situational_self_presentation, attention_distribution, behavioral_diversity
 16. Kenshou (Validation)     -- value_orientation_validation
 17. Sougo Sayou (Interaction) -- interaction_accumulation
 18. Yoki (Expectation)       -- expectation_formation, expectation_lifecycle
 19. Anteika (Stabilization)  -- stabilization_description
 20. Asshuku (Compression)    -- enrichment_compression
 21. Yon-hashira (Four Pillars) -- attachment, continuity, identity, projection managers
 22. Tougou (Integration)     -- orchestrator
"""
...
from .self_reference import (
    ...
    # Responsibility distribution summary (self-reference responsibility summary)
...
# Data structures, Functions, Constants
...
# Enums, Data structures, Functions, Constants
...
__all__ = [
    ...
    # Emotion Cooccurrence Description
    ...
    # ---- 記憶 (Memory) ----
    # Memory Link
    "recall_with_mood", "recall_by_mood",
    # Short-Term Memory
    ...
    # Memory Forgetting and Fixation
    ...
    "get_input_supply_summary",
    # Reference Frequency Description
    ...
    # Introspection Longitudinal View (imports available; not in original __all__)
    # Internal Contradiction Description
    ...
    # Thought
    "generate_thought_candidates", "select_policy",
    # Context Sensitivity
    ...
    # Hypothesis-Observation Pairing (imports available; not in original __all__)
    ...
    # Attention Distribution Description
    ...
    # Behavioral Diversity Description
    ...
    # Expectation Lifecycle Description
