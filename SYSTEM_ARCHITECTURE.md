...
| ディレクトリ | ファイル数 | 総行数 | 説明 |
|-------------|-----------|--------|------|
| psyche/ | 62 | 50,082 | 心理システム本体（orchestrator.py含む） |
| tests/ | 61 | 45,789 | 自動テストコード |
...
| 41 | orchestrator.py | 3,003 | 52 | 統合 | 全モジュール統合管理（PsycheOrchestrator, 46システム, save/load v19(43項目永続化), enrichment(5セクション/26項目), select_policy_dict含む） |
