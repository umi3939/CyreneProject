...
| ディレクトリ | ファイル数 | 総行数 | 説明 |
|-------------|-----------|--------|------|
| psyche/ | 63 | 50,720 | 心理システム本体（orchestrator.py含む） |
| tests/ | 62 | 47,281 | 自動テストコード |
...
| 33 | perception.py | 157 | - | 入力 | 知覚処理（brain.py接続済み, LLM enrichment有効） |
...
| 41 | orchestrator.py | 3,024 | 52 | 統合 | 全モジュール統合管理（PsycheOrchestrator, 47システム, save/load v20(44項目永続化), enrichment(5セクション/27項目), select_policy_dict含む） |
